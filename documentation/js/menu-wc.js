...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">expense-management-system documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/TogglePasswordDirective.html" data-type="entity-link" >TogglePasswordDirective</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/TripEffects.html" data-type="entity-link" >TripEffects</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/BroadcastMessage.html" data-type="entity-link" >BroadcastMessage</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CarRentalExpenseModel.html" data-type="entity-link" >CarRentalExpenseModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ExpenseBaseModel.html" data-type="entity-link" >ExpenseBaseModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/FlightExpenseModel.html" data-type="entity-link" >FlightExpenseModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/HotelExpenseModel.html" data-type="entity-link" >HotelExpenseModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/TaxiExpenseModel.html" data-type="entity-link" >TaxiExpenseModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/TripModel.html" data-type="entity-link" >TripModel</a>
                            </li>
                            <li class="link">
